...
void Display()
{
  unsigned char leftColor[3], rightColor[3], shapeColor[3], shapeColor2[3];
  
  HSVtoRGB (prj.leftColor.h, prj.leftColor.s, prj.leftColor.v, leftColor[0], leftColor[1], leftColor[2]);
  HSVtoRGB (prj.rightColor.h, prj.rightColor.s, prj.rightColor.v, rightColor[0], rightColor[1], rightColor[2]);
  HSVtoRGB (prj.shapeColor.h, prj.shapeColor.s, prj.shapeColor.v, shapeColor[0], shapeColor[1], shapeColor[2]);
  HSVtoRGB (prj.shapeColor2.h, prj.shapeColor2.s, prj.shapeColor2.v, shapeColor2[0], shapeColor2[1], shapeColor2[2]);
  glClear( GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT );
  ...
  if ( showColors ) {
    ...
    sprintf ( colortext, "Shape2 color: R=%3d G=%3d B=%3d  H=%3.0f S=%4.2f V=%4.2f", shapeColor2[0], shapeColor2[1], shapeColor2[2], prj.shapeColor2.h, prj.shapeColor2.s, prj.shapeColor2.v );
        glRasterPos2i ( 10, 52 );
        RenderText2 ( colortext );
...
void Menu( int item )
{
  switch ( item ) {
    ...
    case CMD_EDIT_SHAPE_COLOR:
      ...
      break;
    case CMD_EDIT_SHAPE_COLOR2:
    	selectedColor = &prj.shapeColor2;
    	break;
